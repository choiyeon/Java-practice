 ...
 *  - 자동 초기화가 된다.( 값할당하지 않고 사용하더라도 error가 발생하지 않는다.)<br>
 *  - 하나의 변수만 만들어진다.
 *  - 모든 instance( 객체 )가 하나의 변수를 참조하고 사용한다. - 공용 
 */
public class UseStaticVariable {
	
	//1. 선언) static 데이터형 변수명; - 자동 초기화가된다.
	static int i;// 0
	static char c;// \u0000
	...
	public static void main(String[] args) {
		...
		System.out.println("문자 : ["+ UseStaticVariable.c+"] ["+ (int)UseStaticVariable.c +"]");
...
//		System.out.println( instance2.i );//instance2객체로 접근한 i도 변경된다.
