...
//		super(pf, "부가적인 기능", true); //modal 첫창 클릭 안됨.
		super(pf, "부가적인 기능", false); //non-modal 첫창 클릭 가능. 여러 서브창 띄울 수 있음
		...
		setBounds(pf.getX()+125, pf.getY()+100, 244, 200);//부모의 시작 좌표를 받아 자식 창 위치 설정
