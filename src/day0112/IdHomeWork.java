...
public class IdHomeWork {
	...
	public String idBirth() {
		...
		if (this.sevenIndex == 1 || this.sevenIndex == 2 || this.sevenIndex == 5 || this.sevenIndex == 6) {
			// 1900년대생
			this.birthYear = 1900 + Integer.parseInt(year);
	...
	/**
	 * 6.입력된 주민번호에서 성별을 구해 문자열로 반환
	 * 판단기준)
	 * 뒤의 문자가  1,3,5,7,9 – 남자, 2,4,6,8,0 – 여자
	 * @return
	 */
	public String idSex() {
		if (this.sevenIndex == 1 ||this.sevenIndex == 3||this.sevenIndex == 5||this.sevenIndex == 7||this.sevenIndex == 9) {
			return "남자";
		}else if(this.sevenIndex == 2 ||this.sevenIndex == 4||this.sevenIndex == 6||this.sevenIndex == 8|| this.sevenIndex == 0) {
			return "여자";
		}
		return "idAge() 문제발생";
	}
	...
	public String idZodiac() {
		int zodiacIndex = (this.birthYear - 1924) % 12;
